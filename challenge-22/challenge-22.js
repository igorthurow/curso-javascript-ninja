  ...
  */
  ...
  console.log(
    getFullName.call( igorPerson ),
    ' & ',
    getFullName.call( carolPerson)
  );
  ...
  */
  ...
  console.log(sum(1, 3, 4, 5, 6, 10))
  console.log(sum(1, 5, 8, 4, 3, 15))
  console.log(sum(1, 3, 54, 51, 60, 105))
  ...
  */
  ...
  function justNumbers( string ){
    return string = string.replace(/\D+/gi, ',').split(',');
  }
