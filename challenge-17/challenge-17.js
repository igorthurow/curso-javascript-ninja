...
console.log(text.replace(/Manuel Marques de Sousa/g, 'Igor Thurow da Silveira'));
...
console.log(text.replace(/brasileiro/g, 'sapucaiense'));
...
console.log(text.replace(/O Centauro de Luvas/gi, function ( capturaTotal, primeiraCaptura, segundaCaptura ) {
...
var getMonthNumber = function getMonthNumber ( mouthName ) {
    switch (mouthName) {
...
console.log('O mês de março, setembro e dezembro são representados pelos respectivos meses: ' + getMonthNumber('março') + ', ' + getMonthNumber('setembro') + ' e ' + getMonthNumber('piroca') );
...
var replaceDate = function replaceDate ( capturaTotal, capturaUm, capturaDois, capturaTres ) {
    return capturaUm + '/' + getMonthNumber(capturaDois) + '/' + capturaTres;
}
