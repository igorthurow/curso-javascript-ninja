...
function isOperatorValid ( opr ) {
	return operator[opr] !== undefined;
	// !!operator[opr] daria na mesma <- verifica o equivalente ao booleano da expressão.
}
...
function showErrorMessage ( opr ) {
		return 'A operação ' + opr + ' não permitida!';
}
